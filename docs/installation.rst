...
To install pyGRBaglow, run this command in your terminal:

.. code-block:: console

    $ pip install pyGRBaglow

This is the preferred method to install pyGRBaglow, as it will always install the most recent stable release.
